...
export function SocialProofHeader({ segmentLabel }: SocialProofHeaderProps) {
  return (
    <header className="flex shrink-0 items-center justify-between border-b border-border-default bg-white/80 px-4 pb-3 pt-3 backdrop-blur-sm">
      ...
      <span
        className="max-w-[120px] shrink-0 truncate rounded-full border border-qnb-purple/20 bg-qnb-purple/5 px-2.5 py-1 text-[9px] font-medium text-qnb-purple"
        title={segmentLabel}
      >
        {segmentLabel}
      </span>
